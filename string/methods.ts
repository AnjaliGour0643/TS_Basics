...
let charAt3 = text.charAt(3);
console.log("Character at index 3:", charAt3);

// 2. concat() - Combines two or more strings
let additionalText: string = " Let's learn it.";
let combinedText = text.concat(additionalText);
...
let replacedText = text.replace("awesome", "great");
...
let paddedText: string = "   Hello, World!   ";
...
let charCodeAt3 = text.charCodeAt(3);
...
let indexOfRegexMatch = text.search(/awesome/i);

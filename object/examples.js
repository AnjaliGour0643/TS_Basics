...
var person1 = (_b = {},
    _b[key1] = "Harry",
    _b[key2] = 25 // Using key2 as the property name
,
    _b);
...
var userId = 101;
var user1 = (_c = {},
    _c["".concat(prefix, "name")] = "Anjali",
    _c["".concat(prefix, "id")] = userId,
    _c);
...
var employeeName = employeeInfo.name;
